...
if {$TIME_UNIT == "ns"} {
    ...
    set CONV_FACTOR 1000
} else {
    error "Invalid TIME_UNIT. Use 'ns' or 'ps'."
}

# JTAG CLOCK: 25 MHz
set JTAG_CLK_PERIOD [expr 40 * $CONV_FACTOR]

# REF CLOCK: 32769 Hz
# set REF_CLK_PERIOD 30517
set REF_CLK_PERIOD [expr 30517 * $CONV_FACTOR]

# SYSTEM CLOCK generated by the FLL (the FLL can go higher)
# set FLL_CLK_PERIOD 20
set FLL_CLK_PERIOD [expr 10 * $CONV_FACTOR]
...
set SPI_FLASH_CLK_PERIOD [expr 6.7 * $CONV_FACTOR]

# SPI CLOCK for external devices : ~150MHz
# This clock is	a divided version of the system	clock and depends on the actual	hardware (possible clock divider)
# This values is set according to the "divide_by" value below
# set SPI_CLK_PERIOD 6.7
set SPI_CLK_PERIOD [expr 6.7 * $CONV_FACTOR]
...
create_clock -name "FLL_CLK" -period $FLL_CLK_PERIOD [ get_pins u_heepatia_peripherals/u_fll_subsystem/ref_clk_i ]

# SYSTEM CLOCK
create_generated_clock [ get_pin u_heepatia_peripherals/u_fll_subsystem/clk_mux_fll_soc_i/clk_o ] \
                        -name SYSTEM_CLK -source [ get_pins u_heepatia_peripherals/u_fll_subsystem/ref_clk_i ] -divide_by 1
...
# set_multicycle_path 3 -setup -through u_heepatia_peripherals/u_cgra_top_wrapper/cgra_top_i/cgra_rcs_i/rc_row_gen[*].rc_col_gen[*].rc_i/rc_datapath/rc_alu/mult_read_gen[*].alu_mult_op*_i/d_i
# set_multicycle_path 2 -hold -through u_heepatia_peripherals/u_cgra_top_wrapper/cgra_top_i/cgra_rcs_i/rc_row_gen[*].rc_col_gen[*].rc_i/rc_datapath/rc_alu/mult_read_gen[*].alu_mult_op*_i/d_i
