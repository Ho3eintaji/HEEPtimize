...
# set FLL_CLK_PERIOD [expr 2 * $CONV_FACTOR]
set FLL_CLK_PERIOD [expr 2.3 * $CONV_FACTOR]
# set SYSTEM_CLK_UNCERTAINTY [expr 0.5 * $CONV_FACTOR] 
...
# set_clock_uncertainty $SYSTEM_CLK_UNCERTAINTY [ get_clocks SYSTEM_CLK ]
