...
# TODO: im not sure, buy I put the same libraries as while synthesizing
...
set lib_std(tt) $design(FLOW_ROOT)/hw/asic/std-cells/GF22FDX_SC8T_104CPP_BASE_CSC28R_FDK_RELV05R50/model/timing/db/GF22FDX_SC8T_104CPP_BASE_CSC28R_TT_0P80V_0P00V_0P00V_0P00V_25C.db
...
set lib_fll(tt) $design(FLOW_ROOT)/hw/asic/fll/db/tsmc65_FLL_ss_typical_max_1p08v_125c.db
...
# Initialize an empty list for memory libraries
set lib_mem(tt) ""
# append
lappend lib_mem(tt) $design(FLOW_ROOT)/hw/asic/std-cells-memories/memories/MemViews_6T_512x32_LPP_M4_TT_0_800_0_800_25/model/timing/db/sram512x32m4_TT_0_800_0_800_25_116cpp_TT_0P800V_0P800V_0P000V_0P000V_025C.db
lappend lib_mem(tt) $design(FLOW_ROOT)/hw/asic/std-cells-memories/memories/MemViews_6T_1024x32_LPP_M4_TT_0_800_0_800_25/model/timing/db/sram1024x32m4_TT_0_800_0_800_25_116cpp_TT_0P800V_0P800V_0P000V_0P000V_025C.db
lappend lib_mem(tt) $design(FLOW_ROOT)/hw/asic/std-cells-memories/memories/MemViews_6T_2048x32_LPP_M4_TT_0_800_0_800_25/model/timing/db/sram2048x32m4_TT_0_800_0_800_25_116cpp_TT_0P800V_0P800V_0P000V_0P000V_025C.db
lappend lib_mem(tt) $design(FLOW_ROOT)/hw/asic/std-cells-memories/memories/MemViews_6T_4096x32_LPP_M4_TT_0_800_0_800_25/model/timing/db/sram4096x32m4_TT_0_800_0_800_25_116cpp_TT_0P800V_0P800V_0P000V_0P000V_025C.db
lappend lib_mem(tt) $design(FLOW_ROOT)/hw/asic/std-cells-memories/memories/MemViews_6T_8192x32_LPP_M4_TT_0_800_0_800_25/model/timing/db/sram8192x32m4_TT_0_800_0_800_25_116cpp_TT_0P800V_0P800V_0P000V_0P000V_025C.db
# Join all memory libraries into a single string
set lib_mem(tt) [join $lib_mem(tt) " "]
