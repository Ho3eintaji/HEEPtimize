...
{
   // fft_complex_t *data = malloc(512 * sizeof(fft_complex_t)); // 4096 Bytes
    fft_complex_t *data = (fft_complex_t*)ram_buffer; // 4096 Bytes
...
int main()
{
    ...
    {
        PRINTF("Error in system initialization\n");
        return 1;
    }
