...
void computeFixedPoint(TransformerBlock* transformerBlock, size_t seq_len, int16_t* input, int16_t* input_normalized, int16_t* output, int16_t* intermediate, int16_t* qkv, int16_t* ram_buffer);
